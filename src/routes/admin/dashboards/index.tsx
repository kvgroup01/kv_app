...
export default function DashboardsIndex() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isLancamentosLoading ? (
        ...
        <Card className="flex flex-col items-center justify-center p-12 text-center border-dashed">
          ...
          <p className="text-muted-foreground mb-6 max-w-sm">
            Você ainda não tem nenhum dashboard com os filtros selecionados, ou
            precisa criar seu primeiro.
          </p>
          <Button onClick={() => navigate("/admin/dashboards/novo")}>
                  ...
                  <Card className="h-full flex flex-col group overflow-hidden hover:border-primary/50 transition-colors">
                    ...
                    <CardContent className="flex-1 space-y-4">
                        ...
                        lancamento.slug && (
                          <div className="flex items-center gap-2 p-2 bg-muted/50 rounded-md">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                copiarLink(cliente.slug!, lancamento.slug!)
                              }
                      ...
                      <div className="text-xs text-muted-foreground flex flex-col gap-1 mt-1">
                        <span>
                          Lançamento #{lancamento.$id?.substring(0, 8)}
                        </span>
                      </div>
                    </CardContent>
                    ...
                    <CardFooter className="border-t pt-4 bg-muted/20 gap-2">
                      <Button
                        ...
                        disabled={
                          lancamento.status === "rascunho" || !cliente?.slug
                        }
                      >
                      ...
                      <Button
                        ...
                        className="flex-[0.5]"
                        onClick={() =>
                          navigate(`/admin/dashboards/${lancamento.$id}/editor`)
                        }
                      >
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          {lancamento.status === "rascunho" && (
                            <DropdownMenuItem
                              onClick={() => {
                                toast.promise(
                                  publicarMutation.mutateAsync(lancamento.$id!),
                                  {
                                    loading: "Publicando...",
                          ...
                          {lancamento.status === "ativo" && (
                            <DropdownMenuItem
                              onClick={() => {
                                toast.promise(
                                  encerrarMutation.mutateAsync(lancamento.$id!),
                                  {
                                    loading: "Encerrando...",
                          ...
                          <DropdownMenuItem
                            ...
                            onClick={() =>
                              setLancamentoParaDeletar(lancamento.$id!)
                            }
                          >
      ...
      {/* AlertDialog Delete */}
      <AlertDialog
        open={!!lancamentoParaDeletar}
        onOpenChange={(open) => !open && setLancamentoParaDeletar(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              o dashboard e interromperá qualquer coleta de leads do webhook!
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
