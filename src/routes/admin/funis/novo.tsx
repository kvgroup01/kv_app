      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        {TEMPLATES.map((tpl) => {
          ...
          return (
            <Card 
              key={tpl.id} 
              className="cursor-pointer hover:border-[#FBB03B]/50 transition-all hover:bg-muted/10 group"
              onClick={() => {
            ...
            >
              <CardContent className="p-6 flex items-start gap-4">
                <div className="h-12 w-12 rounded-lg bg-[#FBB03B]/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
